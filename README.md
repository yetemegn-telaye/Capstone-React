...
# Live-Demo
> Here is a link (https://github.com/yetemegn-telaye/Capstone-React.git) to the live page.
...
## Steps
- To clone the project select the desired directory in cmd and run: `git clone https://github.com/yetemegn-telaye/Capstone-React.git`
...
This project is [MIT](https://github.com/yetemegn-telaye/Capstone-React/blob/dev/LICENSE) licensed.
